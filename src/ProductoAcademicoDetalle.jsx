...
import {CompContext} from "./ProductoAcademicoGrid";
...
export default function ProductoAcademicoDetalle({nombre, open, handleClose}) {
    const competenciasContext = useContext(CompContext);
                            ...
                            return (
                                ...
                                >
                                    <AccordionSummary
                                        ...
                                        id="panel1a-header"
                                    >
                                        <Typography>{competencia.nombre}</Typography>
                                    </AccordionSummary>
                                    <AccordionDetails>
                                        {competencia.especificas.map(especifica => {
                                            return (
                                                ...
                                                >
                                                    <ToggleButton value={especifica.id}>
                                                        {especifica.nombre}
                                                    </ToggleButton>
                                                </ToggleButtonGroup>
                                            )
