...
const ProductoAcademicoNota = ({index, porcentaje, handleRowUp, handleRowDown, handleDeleteRow}) => {
    ...
    const handleKeyDown = (event) => {
        if (event.key === 'Enter' || event.key === 'Escape') comprobarPtj(event);
    }
    ...
    return (
        <div className="card__nota">
            ...
            <p>Nota {index + 1}</p>
            <svg onClick={handleRowUp} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
            ...
            </svg>
            {
                (toggle) ?
                    ...
                    <p onDoubleClick={() => setToggle(true)}>{ptj < 0 ? 0 : ptj} %</p>
            }
            <svg onClick={handleRowDown} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
